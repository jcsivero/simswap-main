...
######### select face by mouse (instant) ########

def crop_source_image(source_image):
    
    showCrosshair = False
    show_cropped = source_image

    r = cv2.selectROI("Select the face to be replaced", show_cropped,showCrosshair)
...
############# select face to be swapped by mouse (instant) #################
        ...
        specific_person_whole = crop_source_image(image)
