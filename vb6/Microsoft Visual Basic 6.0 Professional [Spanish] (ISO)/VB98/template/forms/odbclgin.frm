...
Begin VB.Form frmODBCLogon 
   ...
   Caption         =   "Inicio de sesión de ODBC"
   ClientHeight    =   3180
   ClientLeft      =   2850
   ClientTop       =   1755
   ClientWidth     =   4740
   ControlBox      =   0   'False
   Icon            =   "Inicio de sesión de ODBC.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3180
   ...
   Begin VB.Frame fraStep3 
      ...
      Begin VB.ComboBox cboDSNList 
         Height          =   315
         ItemData        =   "Inicio de sesión de ODBC.frx":000C
         Left            =   1320
         List            =   "Inicio de sesión de ODBC.frx":000E
         Sorted          =   -1  'True
...
Private Sub cmdOK_Click()
    ...
    MsgBox
    "Para abrir una conexión ADO, use:" & vbCrLf & _
    "Set gConnection = New Connection" & vbCrLf & _
    "gConnection.Open """ & sADOConnect & """" & vbCrLf & vbCrLf &
    "Para abrir un objeto de base de datos DAO, use:" & vbCrLf & _
    "Set gDatabase = OpenDatabase(vbNullString, 0, 0, sDAOConnect)" & vbCrLf & vbCrLf & _
    "Para abrir una conexión RDO, use:" & vbCrLf & _
